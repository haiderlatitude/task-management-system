...
<div id="ascrail2002" class="nicescroll-rails nicescroll-rails-vr"
    ...
    <div class="nicescroll-cursors"
         style="position: relative; top: 0px; float: right; width: 6px; height: 69px; background-color: rgb(66, 66, 66); border: 1px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 5px; touch-action: none;"></div>
</div>
<div id="ascrail2002-hr" class="nicescroll-rails nicescroll-rails-hr"
     style="height: 8px; z-index: 892; top: 295.333px; left: 0px; position: fixed; display: none; width: 242px; opacity: 0;">
    <div class="nicescroll-cursors"
